                    ...
                    <ul class="navbar-nav d-flex justify-content-between">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{ route('client_login_form') }}">Connexion</a>
                                <a class="dropdown-item" href="{{ route('client.register') }}">Créer un compte</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
            ...
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-lg-6 hero-left">
                        <h1 class="display-4 mb-5">Découvrez et réservez
                             <br>le meilleur restaurant</h1>
                        <div class="mb-2">
                            <a class="btn btn-primary btn-shadow btn-lg" href="{{ route('client.reservation') }}" role="button">Reserve maintenant</a>
                        ...
                        <ul class="hero-info list-unstyled d-flex text-center mb-0">
                            ...
                            <li class="">
                                ...
                                <h5>
                                    Réservation facile
                                    Instantané, gratuit, partout. 24/7
                                </h5>
                            </li>
                        </ul>
                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col-sm-5 img-bg d-flex shadow align-items-center justify-content-center justify-content-md-end img-2"
                            style="background-image: url(img/table1.jpg);">
                        ...
                        <div class="col-sm-7 py-5 pl-md-0 pl-4">
                            ...
                            <div class="pl-lg-5 ml-md-5">
                                <p> Resto est la première plateforme de réservation et de découverte de restaurants en ligne
                                    en Europe et en Australie. Découvrez plus de 60 000 des meilleurs restaurants de Londres,
                                     Paris et Barcelone. Sydney et bien d'autres avec notre sélection inégalée de restaurants
                                      pour tout ce que vous voulez Recherchez la disponibilité des restaurants à tout moment et
                                       au meilleur prix. Avec plus de 20 millions d'avis vérifiés pour vous guider, vous pouvez
                                       découvrir le restaurant parfait sur Resto.<br><br>
                                        Chaque jour et pour toutes les occasions, vous pouvez profiter de réductions allant jusqu'à 50 %
                                    sur la facture alimentaire et également gagner des points de récompense appelés Yum, que vous
                                    pouvez échanger dans les restaurants participants.</p>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="footer-widget pr-lg-5 pr-0">
                            ...
                            <p>Resto est une plateforme en ligne qui permet aux utilisateurs
                                 de découvrir et de réserver des restaurants dans différentes villes du monde.</p>
                    ...
                    <div class="col-md-12 d-flex align-items-center">
                        <p class="mx-auto text-center mb-0">Les offres promotionnelles sont soumises aux conditions affichées sur la page du restaurant. Les offres sur les boissons alcoolisées sont strictement réservées aux personnes majeures.
                             L'abus d'alcool est dangereux pour la santé. A boire avec modération.</p>
                    </div>
