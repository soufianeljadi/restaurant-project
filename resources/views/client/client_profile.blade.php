                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col ms-md-n2 profile-user-info">
                                    ...
                                    <div class="pb-3"><i class="fa fa-map-marker"></i>
                                        {{ Auth::guard('client')->user()->location }}</div>
                                    <div class="about-text">{{ Auth::guard('client')->user()->description }}</div>
                                </div>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <p class="col-sm-10 ">{{ Auth::guard('client')->user()->location }}
                                                    </p>
                                                </div>
                                                <div class="row">
                                                    <p class="col-sm-2 text-muted mb-0 mb-sm-3">Description</p>
                                                    <p class="col-sm-10">
                                                        {{ Auth::guard('client')->user()->description }}</p>
                                                </div>
                                            </div>
                                        </div>
