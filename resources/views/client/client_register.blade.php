						...
						<div class="account-box">
							<div class="login-right">
								<div class="login-header">
									<h3><span>Client</span> Register</h3>
								...
								<form method="post" action="{{ route('client.register.create') }}">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label class="form-control-label">Nom du client</label>
									...
									<div class="account-footer text-center mt-3">
										Vous avez déjà un compte? <a class="forgot-link mb-0" href="{{ route('client_login_form') }}">Login</a>
									</div>
								</form>
								<!-- /Register Form -->
