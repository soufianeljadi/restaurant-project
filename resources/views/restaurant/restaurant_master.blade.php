        ...
        <div class="header">
            ...
            <ul class="nav user-menu">
                ...
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                        <span class="user-img"><img class="rounded-circle" src="{{ asset('img/resto_user.png') }}"
                        ...
                        <div class="user-header">
                            <div class="user-text">
                                <div class="avatar avatar-sm">
                                    <img src="{{ asset('img/resto_user.png') }}" alt="User Image"
                                        class="avatar-img rounded-circle">
                                </div>
                            </div>
                                <div class="user-text">
                                    <h6>{{ Auth::guard('restaurant')->user()->name }}</h6>
                                    <p class="text-muted mb-0">Restaurant</p>
                                </div>

                        </div>
                        <a class="dropdown-item" href="{{ route('restaurant.profile') }}">Mon profil</a>
                        <a class="dropdown-item" href="{{ route('restaurant.logout') }}">Se déconnecter</a>
                    </div>
                </li>
                <!-- /User Menu -->
